...
Step 4 : Declare the main function. In the main function set up the device & data size of matrix , perform memory allocation on host memory & initialize the data at host side then add 
matrix at host side for result checks followed by invoking kernel at host side. Then warm-up kernel,check the kernel error, and check device for results.Finally free the device global memory and reset device.
...
```
![parallel_exp_04](https://github.com/BALUREDDYVELAYUDHAMGOWTHAM/PCA-Matrix-Addition-With-Unified-Memory/assets/119559905/1384a6a5-1d71-4384-8a85-caf75575db33)
...
root@MidPC:/home/student/Desktop#
```
![parallel__exp_04](https://github.com/BALUREDDYVELAYUDHAMGOWTHAM/PCA-Matrix-Addition-With-Unified-Memory/assets/119559905/17b2eab1-76ed-4926-b5a1-147d09a7b585)
